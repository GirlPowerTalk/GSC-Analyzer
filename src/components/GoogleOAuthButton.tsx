...
interface GoogleOAuthButtonProps {
  onAuthResult: (success: boolean, token?: string) => void;
}

const GoogleOAuthButton = ({ onAuthResult }: GoogleOAuthButtonProps) => {
  ...
  return (
    ...
    >
      ...
      {isAuthenticating ? "Connecting..." : "Connect with Google Search Console"}
    </Button>
  );
};
